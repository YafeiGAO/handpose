...
class ColorHandPose3DNetwork(object):
    ...
    def inference(self, image, hand_side, evaluation):
        ...
        hand_scoremap,loss_z = self.inference_detection(image)
    ...
    def inference_detection(image, train=False):
        ...
        with tf.variable_scope('HandSegNet'):
            ...
            z, z_mu, z_log_sigma, loss_z = variational_bayes(score_full, n_code=num_outputs)
        ...
        return scoremap_list_large, loss_z
